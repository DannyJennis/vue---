<template>
  <div id="me">
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <router-link class="navbar-brand col-sm-3 col-md-2 mr-0" to="/home"
        >VUE购物商城</router-link
      >
          ...
          <div class="sidebar-sticky">
            ...
            <el-menu default-active="1" class="el-menu-vertical-demo">
              ...
              <el-submenu index="2">
                ...
                <el-menu-item-group>
                  <el-menu-item index="2-1" @click="goTo('/me/update')"
                    >修改基本信息</el-menu-item
                  >
                  <el-menu-item index="2-2" @click="goTo('/me/editphone')"
                    >修改手机号</el-menu-item
                  >
                  <el-menu-item index="2-3" @click="goTo('/me/editpwd')"
                    >修改密码</el-menu-item
                  >
                </el-menu-item-group>
              </el-submenu>
              <el-menu-item index="3" @click="goTo('/me/addressList')">
                <i class="el-icon-location-outline"></i>
                <span slot="title">我的地址</span>
              </el-menu-item>
              <el-menu-item index="4" @click="goTo('/me/sales')">
