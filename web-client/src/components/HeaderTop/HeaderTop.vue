<template>
  <div class="header_nav">
    ...
    <ul>
      ...
      <li><a @click.prevent="goAdmin">管理员</a></li>
      <li><a @click.prevent="talling">联系客服</a></li>
      <!-- <li><a>网站导航</a></li> -->
        <el-dropdown :hide-on-click="false">
        <el-dropdown trigger="click" class="xiala">
          <span class="el-dropdown-link">
            网站导航<i class="el-icon-arrow-down el-icon--right"></i>
          </span>
          <el-dropdown-menu slot="dropdown">
            
            <el-dropdown-item>特色主题</el-dropdown-item>
            <el-dropdown-item>行业频道</el-dropdown-item>
            <el-dropdown-item>生活服务</el-dropdown-item>
            <el-dropdown-item>更多精选</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
        </el-dropdown>
...
export default {
  ...
  methods: {
    talling() {
      this.$alert("手机/微信：17727889832", "请添加客服联系方式", {
        confirmButtonText: "已联系客服",
        callback: (action) => {
          this.$message({
            type: "info",
            message: `感谢您的联系`,
