...
// 删除用户
export const deleteUser = (id) => ajax(BASE_URL + '/api/delete_user', {id}, 'POST');
...
// 请求地址
export const getAdderss = () => ajax(BASE_URL + '/api/address');

// 添加地址
export const addAddress = (address_id, user_name, user_phone, user_address) => ajax(BASE_URL + '/api/add_address', {address_id, user_name, user_phone, user_address}, 'POST');

// 拼接地址
export const getAdderss_add = () => ajax(BASE_URL + '/api/address_add');

// 删除地址
export const deleteAddress = (address_id) => ajax(BASE_URL + '/api/delete_address',{address_id},'POST');
